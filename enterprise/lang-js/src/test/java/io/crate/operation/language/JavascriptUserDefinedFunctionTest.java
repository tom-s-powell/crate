...
public class JavascriptUserDefinedFunctionTest extends AbstractScalarFunctionsTest {
    ...
    private UserDefinedFunctionService udfService = new UserDefinedFunctionService(
    ...
    public void testObjectReturnType() throws Exception {
        registerUserDefinedFunction("f", ObjectType.untyped(), List.of(),
    ...
    public void testArrayReturnType() throws Exception {
        registerUserDefinedFunction("f", DataTypes.DOUBLE_ARRAY, List.of(), "function f() { return [1, 2]; }");
        assertEvaluate("f()", List.of(1.0, 2.0));
    }

    @Test
    public void testTimestampReturnType() throws Exception {
        registerUserDefinedFunction("f", DataTypes.TIMESTAMPZ, List.of(),
    ...
    public void testIpReturnType() throws Exception {
        registerUserDefinedFunction("f", DataTypes.IP, List.of(), "function f() { return \"127.0.0.1\"; }");
        assertEvaluate("f()", DataTypes.IP.value("127.0.0.1"));
    }

    @Test
    public void testPrimitiveReturnType() throws Exception {
        registerUserDefinedFunction("f", DataTypes.INTEGER, List.of(), "function f() { return 10; }");
        assertEvaluate("f()", 10);
    }

    @Test
    public void testObjectReturnTypeAndInputArguments() throws Exception {
        registerUserDefinedFunction("f", DataTypes.FLOAT, List.of(DataTypes.DOUBLE, DataTypes.SHORT),
    ...
    public void testGeoTypeReturnTypeWithWKT() throws Exception {
        registerUserDefinedFunction("f", DataTypes.GEO_POINT, List.of(),
    ...
    public void testFunctionWrongNameInFunctionBody() throws Exception {
        ...
        assertThat(
            udfService.getLanguage(JS).validate(udfMeta),
            containsString("The name of the function signature 'f' doesn't " +
                           "match the function name in the function definition"));
    }

    @Test
    public void testNormalizeOnObjectInput() throws Exception {
        registerUserDefinedFunction("f", ObjectType.untyped(), List.of(ObjectType.untyped()),
    ...
    public void testNormalizeOnArrayInput() throws Exception {
        registerUserDefinedFunction("f", DataTypes.LONG, List.of(DataTypes.DOUBLE_ARRAY),
    ...
    public void testNormalizeOnStringInputs() throws Exception {
        registerUserDefinedFunction("f", DataTypes.STRING, List.of(DataTypes.STRING),
            "function f(x) { return x; }");
    ...
    public void testJavaScriptFunctionReturnsNull() throws Exception {
        registerUserDefinedFunction("f", DataTypes.STRING, List.of(), "function f() { return null; }");
        assertEvaluate("f()", null);
    }

    @Test
    public void testStringArrayTypeArgument() throws Exception {
        registerUserDefinedFunction("f", DataTypes.STRING, List.of(DataTypes.STRING_ARRAY),
